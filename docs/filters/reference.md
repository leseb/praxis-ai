...
| [`openai_callout_seed_upstream`](openai_callout_seed_upstream.md) | Internal outbound-chain filter that dials the callout upstream the API client pinned for a configured Files API request. |
