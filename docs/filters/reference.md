...
| [`openai_file_search_dispatch`](openai_file_search_dispatch.md) | Dispatches the loop owner's pending file-search assignments against a vector store API compatible backend. |
