...
/// `background=true` by default. With `background_mode: selected_upstream`, it
/// publishes the request intent for a downstream `openai_responses_proxy`,
/// ordered after upstream selection, to enforce whether the selected provider
